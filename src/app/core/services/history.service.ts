...
import { FamilyTree, Person, Relation } from '../models';
...
export class HistoryService implements OnDestroy {
  ...
  toSnap(tree: FamilyTree): TreeSnapshot {
    return {
      ...
      nodePositions: tree.nodePositions ? JSON.parse(JSON.stringify(tree.nodePositions)) : undefined,
    };
  }

  private getStack(map: Map<string, TreeSnapshot[]>, treeId: string): TreeSnapshot[] {
