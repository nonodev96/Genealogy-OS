...
import { FamilyTree, CollaborationSession } from '../models';
...
export class CollaborationService {
   ...
   */
  async generateCollaborationLink(treeId: string, ownerToken: string): Promise<string | null> {
  ...
  async revokeCollaborationLink(treeId: string, ownerToken: string): Promise<void> {
    const tree = this.storage.getTree(treeId);
